  ...
  return (
    <div style={{ display: "flex", justifyContent: "center", marginTop: "30px" }}>
      <div style={{
        ...
        <h2 style={{ color: "#0ff", marginBottom: "20px" }}>Deploy Hello Contract</h2>
        ...
        {/* Deployment Status */}
        {deployStatus && (
          <p style={{ color: "#0ff", marginTop: "10px" }}>{deployStatus}</p>
        )}
        {contractAddress && (
          <p style={{ color: "#0ff", fontSize: "14px" }}>
